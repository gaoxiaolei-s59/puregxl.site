...
export const openSource: CardItem[] = [
	{
		...
		desc: "完善工具调用错误处理文档，补充异常传播与调用方处理方式。",
		tags: ["AI Agent", "文档"],
		url: "https://github.com/microsoft/autogen/pull/8033",
		badge: "1 PR 进行中",
		badgeColor: "amber",
	},
	{
		title: "Spring AI",
		desc: "修复 OpenAI 流式响应取消后未关闭的问题，并持续补充格式化器、MCP 与 Bedrock 相关测试和文档。",
		tags: ["Spring AI", "Java"],
		url: "https://github.com/spring-projects/spring-ai/pull/6656",
		badge: "1 PR 已合并 · 5 PR 进行中",
		badgeColor: "green",
	},
	{
		title: "Spring AI Alibaba",
		desc: "修复 ToolExample 悬空引用导致的编译失败，并为 VariableUtils、CollectionsUtils 等工具补充单元测试。",
		tags: ["Spring AI", "Java"],
		url: "https://github.com/alibaba/spring-ai-alibaba/pull/4731",
		badge: "1 PR 已合并 · 2 PR 进行中",
		badgeColor: "green",
	},
	{
		title: "Apache Dubbo",
		desc: "修复流式解码器关闭后的输入资源释放问题，并参与 MockClusterInvoker 与 Triple 代码生成器改进。",
		tags: ["RPC", "Apache", "Java"],
		url: "https://github.com/apache/dubbo/pull/16391",
		badge: "1 PR 已合并 · 2 PR 进行中",
		badgeColor: "green",
	},
	{
		title: "Apache Kafka",
		desc: "修复 Raft 模块、OAuth 测试与 Javadoc 中的语法和格式问题。",
		tags: ["消息队列", "Apache"],
	...
	},
	{
		...
		desc: "修复沙箱递归 glob 匹配，并确保 OllamaOptions 构建时保留 executionConfig。",
		tags: ["AI Agent", "Java"],
		url: "https://github.com/agentscope-ai/agentscope-java/pull/2011",
		badge: "2 PR 已合并",
		badgeColor: "green",
	},
	{
	...
	{
		title: "LangChain4j",
		desc: "为 Google AI Gemini 的 FinishReasonMapper 与请求参数补充单元测试。",
		tags: ["AI", "Java"],
		url: "https://github.com/langchain4j/langchain4j/pull/5715",
		badge: "2 PR 已合并",
		badgeColor: "green",
	},
];
